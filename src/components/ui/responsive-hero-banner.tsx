                ...
                <div className="sm:pt-28 md:pt-32 lg:pt-40 max-w-7xl mx-auto pt-28 px-6 pb-16">
                    <div className="mx-auto max-w-3xl text-center">
                        <div className="mb-6 inline-flex items-center gap-3 rounded-full bg-white/10 px-2.5 py-2 ring-1 ring-white/15 backdrop-blur animate-fade-slide-in-1">
                            <span className="inline-flex items-center text-xs font-medium text-white rounded-full py-0.5 px-2 font-sans" style={{ background: '#1B3A6B' }}>
                                {badgeLabel}
                            </span>
                        ...
                        <h1 className="sm:text-5xl md:text-6xl lg:text-7xl leading-tight text-4xl text-white tracking-tight font-normal animate-fade-slide-in-2" style={{ fontFamily: 'Instrument Serif, Georgia, serif' }}>
                            {title}
                        ...
                        <div className="flex flex-col sm:flex-row sm:gap-4 mt-10 gap-3 items-center justify-center animate-fade-slide-in-4">
                            <a
                                ...
                                className="inline-flex items-center gap-2 text-sm font-medium text-white rounded-full py-3 px-5 font-sans transition-colors"
                                style={{ background: '#1B3A6B' }}
                                onMouseEnter={e => (e.currentTarget.style.background = '#152E56')}
                    ...
                    {!statsContent && partners.length > 0 && (
                        <div className="mx-auto mt-20 max-w-5xl">
