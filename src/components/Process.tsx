...
const steps = [
  ...
  },
  {
    number: '02',
    label: 'BRIEF',
    title: 'Vi planerar varje sektion tillsammans.',
    body: 'Du vet exakt vad du får. Ingen överraskning när sajten är klar.',
    bg: '#FAFAFA',
    textColor: '#1A1A18',
  },
  {
    number: '03',
    label: 'BYGGE',
    title: 'Klart på 5–10 arbetsdagar.',
    body: 'Vi sätter ett datum och håller det. Du kan följa med i realtid.',
    bg: '#0D1B2A',
    textColor: '#FAFAFA',
  },
  {
